        ...
        while True:
            ...
            if ltype in self.lr_table.lr_action[current_state]:
                ...
                if self.error_handler is not None:
                    if state is None:
                        self.error_handler(lookahead, current_lookahead_token, original_tokenizer)
                    else:
                        self.error_handler(state, lookahead, current_lookahead_token, original_tokenizer)
